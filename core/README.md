...
[![Packaging status](https://repology.org/badge/tiny-repos/haskell:kilns-haskell.svg)](https://repology.org/project/haskell:kilns-haskell/versions)
[![latest packaged versions](https://repology.org/badge/latest-versions/haskell:kilns-haskell.svg)](https://repology.org/project/haskell:kilns-haskell/versions)
...
This package is licensed under [The GNU AGPL 3.0 only](./LICENSE). If you need a license for usage that isn’t covered under the AGPL, please contact [Greg Pfeil](mailto:greg@technomadic.org?subject=licensing%20kilns-haskell).
