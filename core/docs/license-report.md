...
## Direct dependencies of `kilns:lib:kilns`
...
| `base-unicode-symbols` | [`0.2.4.2`](http://hackage.haskell.org/package/base-unicode-symbols-0.2.4.2) | [`BSD-3-Clause`](http://hackage.haskell.org/package/base-unicode-symbols-0.2.4.2/src/LICENSE) | Unicode alternatives for common functions and operators |  |
| `charset` | [`0.3.12`](http://hackage.haskell.org/package/charset-0.3.12) | [`BSD-3-Clause`](http://hackage.haskell.org/package/charset-0.3.12/src/LICENSE) | Fast unicode character sets based on complemented PATRICIA tries |  |
| **`containers`** | [`0.7`](http://hackage.haskell.org/package/containers-0.7) | [`BSD-3-Clause`](http://hackage.haskell.org/package/containers-0.7/src/LICENSE) | Assorted concrete container types | `binary`, `charset`, `hashable`, `multiset` |
| `multiset` | [`0.3.4.3`](http://hackage.haskell.org/package/multiset-0.3.4.3) | [`BSD-3-Clause`](http://hackage.haskell.org/package/multiset-0.3.4.3/src/LICENSE) | The Data.MultiSet container type |  |

## Indirect transitive dependencies

| Name | Version | [SPDX](https://spdx.org/licenses/) License Id | Description | Depended upon by |
| --- | --- | --- | --- | --- |
| **`array`** | [`0.5.7.0`](http://hackage.haskell.org/package/array-0.5.7.0) | [`BSD-3-Clause`](http://hackage.haskell.org/package/array-0.5.7.0/src/LICENSE) | Mutable and immutable arrays | `binary`, `charset`, `containers`, `deepseq`, `stm`, `text` |
| **`binary`** | [`0.8.9.2`](http://hackage.haskell.org/package/binary-0.8.9.2) | [`BSD-3-Clause`](http://hackage.haskell.org/package/binary-0.8.9.2/src/LICENSE) | Binary serialisation for Haskell values using lazy ByteStrings | `text` |
| **`bytestring`** | [`0.12.1.0`](http://hackage.haskell.org/package/bytestring-0.12.1.0) | [`BSD-3-Clause`](http://hackage.haskell.org/package/bytestring-0.12.1.0/src/LICENSE) | Fast, compact, strict and lazy byte strings with a list interface | `binary`, `charset`, `filepath`, `hashable`, `os-string`, `text` |
| **`deepseq`** | [`1.5.0.0`](http://hackage.haskell.org/package/deepseq-1.5.0.0) | [`BSD-3-Clause`](http://hackage.haskell.org/package/deepseq-1.5.0.0/src/LICENSE) | Deep evaluation of data structures | `bytestring`, `containers`, `filepath`, `hashable`, `multiset`, `os-string`, `pretty`, `text`, `unordered-containers` |
...
| `hashable` | [`1.5.0.0`](http://hackage.haskell.org/package/hashable-1.5.0.0) | [`BSD-3-Clause`](http://hackage.haskell.org/package/hashable-1.5.0.0/src/LICENSE) | A class for types that can be converted to a hash value | `unordered-containers` |
...
| **`template-haskell`** | [`2.22.0.0`](http://hackage.haskell.org/package/template-haskell-2.22.0.0) | [`BSD-3-Clause`](http://hackage.haskell.org/package/template-haskell-2.22.0.0/src/LICENSE) | Support library for Template Haskell | `bytestring`, `containers`, `exceptions`, `filepath`, `os-string`, `text`, `unordered-containers` |
...
| **`transformers`** | [`0.6.1.1`](http://hackage.haskell.org/package/transformers-0.6.1.1) | [`BSD-3-Clause`](http://hackage.haskell.org/package/transformers-0.6.1.1/src/LICENSE) | Concrete functor and monad transformers | `exceptions`, `mtl` |
| `unordered-containers` | [`0.2.20.1`](http://hackage.haskell.org/package/unordered-containers-0.2.20.1) | [`BSD-3-Clause`](http://hackage.haskell.org/package/unordered-containers-0.2.20.1/src/LICENSE) | Efficient hashing-based container types | `charset` |
